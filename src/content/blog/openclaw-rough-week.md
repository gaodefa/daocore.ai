---
title: "DaoCore Had a Rough Week"
...
**TL;DR:** DaoCore had a rough week. 2026.4.29 made it obvious. Sorry. We are making core smaller, moving optional stuff to [ClawHub](https://clawhub.ai/), and announcing LTS separately later in May.
...
This also exposed an operating problem: DaoCore was still too founder-driven. Too much release, review, packaging and support work sat with me. Through the DaoCore Foundation, and with help from OpenAI, we are building a real team around the project.
...
DaoCore will keep getting more secure. It will also get smaller. But it has to stay boringly reliable while we do that.
